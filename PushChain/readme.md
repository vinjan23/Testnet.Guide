...
### update
```
wget https://github.com/pushchain/push-chain-node/releases/download/v0.0.18/push-chain_0.0.18_linux_amd64.tar.gz
tar -xzvf push-chain_0.0.18_linux_amd64.tar.gz
rm push-chain_0.0.18_linux_amd64.tar.gz
chmod +x $HOME/bin/pchaind
```
```
