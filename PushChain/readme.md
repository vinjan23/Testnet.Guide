...
```
```
wget https://github.com/pushchain/push-chain-node/releases/download/v0.0.26/push-chain_0.0.26_linux_amd64.tar.gz
tar -xzvf push-chain_0.0.26_linux_amd64.tar.gz
rm push-chain_0.0.26_linux_amd64.tar.gz
chmod +x $HOME/bin/pchaind
```
```
sudo systemctl stop pchaind
