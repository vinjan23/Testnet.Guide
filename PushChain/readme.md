...
### update
```
wget https://github.com/pushchain/push-chain-node/releases/download/v0.0.32/push-chain_0.0.32_linux_amd64.tar.gz
tar -xzvf push-chain_0.0.32_linux_amd64.tar.gz
rm push-chain_0.0.32_linux_amd64.tar.gz
chmod +x $HOME/bin/pchaind
```
```
...
```
```
wget https://github.com/pushchain/push-chain-node/releases/download/v0.0.33/push-chain_0.0.33_linux_amd64.tar.gz
tar -xzvf push-chain_0.0.33_linux_amd64.tar.gz
rm push-chain_0.0.33_linux_amd64.tar.gz
chmod +x $HOME/bin/pchaind
```
```
sudo systemctl stop pchaind
