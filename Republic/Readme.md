...
### Delegate
```
republicd tx staking delegate $(republicd keys show wallet --bech val -a) 3900000000000000000000arai --from wallet --chain-id raitestnet_77701-1 --gas-prices=2500000000arai --gas-adjustment=1.5 --gas=auto
```
```
