...
cp $HOME/.kiichain3/cosmovisor/current/bin/kiichaind $HOME/.kiichain3/cosmovisor/upgrades/v2.0.0/bin/
```
```
mkdir -p $HOME/.kiichain3/cosmovisor/upgrades/v3.0.0/bin
mv build/kiichaind $HOME/.kiichain3/cosmovisor/upgrades/v3.0.0/bin/
rm -rf build
```
```
cd $HOME
...
git checkout v3.0.0
make install
cp -a ~/go/bin/kiichaind ~/.kiichain3/cosmovisor/upgrades/v3.0.0/bin/kiichaind
```
```
ls -l $HOME/.kiichain3/cosmovisor/current
rm $HOME/.kiichain3/cosmovisor/current
ln -s $HOME/.kiichain3/cosmovisor/upgrades/v3.0.0 $HOME/.kiichain3/cosmovisor/current
```
```
